      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-[#e2e8b0] mb-8 max-w-md text-lg">
            ...
            <a 
              ...
              className="inline-block bg-[#e2e8b0] text-[#586116] px-8 py-4 rounded-full font-bold hover:bg-emerald-50 transition shadow-lg"
            >
